...
namespace Mod_Hub_Base
{
	namespace PLAYER
	{
		...
		static const const char* GET_PLAYER_NAME(Player player) { return invoke<char*>(0x6D0DE6A7B5DA71F8, player); } // 0x6D0DE6A7B5DA71F8 0x406B4B20
		...
		static const const char* GIVE_ACHIEVEMENT_TO_PLAYER(Hash achievement) { return invoke<char*>(0xBEC7076D64130195, achievement); } // 0xBEC7076D64130195 0x822BC992
	...
	namespace ENTITY
	{
		...
		static BOOL HAS_ENTITY_ANIM_FINISHED(Entity entity, const const char* animDict, const const char* animName, int p3) { return invoke<BOOL>(0x20B711662962B472, entity, animDict, animName, p3); } // 0x20B711662962B472 0x1D9CAB92
		...
		static float GET_ENTITY_ANIM_CURRENT_TIME(Entity entity, const const char* animDict, const const char* animName) { return invoke<float>(0x346D81500D088F42, entity, animDict, animName); } // 0x346D81500D088F42 0x83943F41
		static float GET_ENTITY_ANIM_TOTAL_TIME(Entity entity, const const char* animDict, const const char* animName) { return invoke<float>(0x50BD2730B191E360, entity, animDict, animName); } // 0x50BD2730B191E360 0x433A9D18
		static float _GET_ANIM_DURATION(const char* animDict, const const char* animName) { return invoke<float>(0xFEDDF04D62B8D790, animDict, animName); } // 0xFEDDF04D62B8D790
		...
		static const const char* GET_ENTITY_SCRIPT(Entity entity, ScrHandle* script) { return invoke<char*>(0xA6E9C38DB51D7748, entity, script); } // 0xA6E9C38DB51D7748 0xB7F70784
		...
		static BOOL IS_ENTITY_IN_ZONE(Entity entity, const const char* zone) { return invoke<BOOL>(0xB6463CF6AF527071, entity, zone); } // 0xB6463CF6AF527071 0x45C82B21
		...
		static BOOL IS_ENTITY_PLAYING_ANIM(Entity entity, const const char* animDict, const const char* animName, int taskFlag) { return invoke<BOOL>(0x1F0B79228E461EC9, entity, animDict, animName, taskFlag); } // 0x1F0B79228E461EC9 0x0D130D34
		...
		static int GET_ENTITY_BONE_INDEX_BY_NAME(Entity entity, const const char* boneName) { return invoke<int>(0xFB71170B7E76ACBA, entity, boneName); } // 0xFB71170B7E76ACBA 0xE4ECAC22
		...
		static BOOL PLAY_ENTITY_ANIM(Entity entity, const const char* animName, const const char* animDict, float p3, BOOL loop, BOOL stayInAnim, BOOL p6, float delta, Any bitset) { return invoke<BOOL>(0x7FB218262B810701, entity, animName, animDict, p3, loop, stayInAnim, p6, delta, bitset); } // 0x7FB218262B810701 0x878753D5
		static BOOL PLAY_SYNCHRONIZED_ENTITY_ANIM(Entity entity, int SceneID, const const char* animName, const const char* animDict, float speed, float speedMult, int flag, float flag2) { return invoke<BOOL>(0xC77720A12FE14A86, entity, SceneID, animName, animDict, speed, speedMult, flag, flag2); } // 0xC77720A12FE14A86 0x012760AA
		static BOOL PLAY_SYNCHRONIZED_MAP_ENTITY_ANIM(float posX, float posY, float posZ, float radius, Object prop, int sceneID, const const char* animName, const const char* animDict, float playbackRate, float unkFlag, BOOL unkBool, float unkFlag2) { return invoke<BOOL>(0xB9C54555ED30FBC4, posX, posY, posZ, radius, prop, sceneID, animName, animDict, playbackRate, unkFlag, unkBool, unkFlag2); } // 0xB9C54555ED30FBC4 0xEB4CBA74
		...
		static Any STOP_ENTITY_ANIM(Entity entity, const const char* animation, const const char* animGroup, float p3) { return invoke<Any>(0x28004F88151E03E0, entity, animation, animGroup, p3); } // 0x28004F88151E03E0 0xC4769830
		...
		static BOOL FIND_ANIM_EVENT_PHASE(const char* animDictionary, const const char* animName, const const char* p2, Any* p3, Any* p4) { return invoke<BOOL>(0x07F1BE2BCCAA27A7, animDictionary, animName, p2, p3, p4); } // 0x07F1BE2BCCAA27A7 0xC41DDA62
		static void SET_ENTITY_ANIM_CURRENT_TIME(Entity entity, const const char* animDictionary, const const char* animName, float time) { invoke<Void>(0x4487C259F0F70977, entity, animDictionary, animName, time); } // 0x4487C259F0F70977 0x99D90735
		static void SET_ENTITY_ANIM_SPEED(Entity entity, const const char* animDictionary, const const char* animName, float speedMultiplier) { invoke<Void>(0x28D1A16553C51776, entity, animDictionary, animName, speedMultiplier); } // 0x28D1A16553C51776 0x3990C90A
	...
	namespace PED
	{
		...
		static void SET_PED_STEALTH_MOVEMENT(Ped ped, BOOL p1, const const char* action) { invoke<Void>(0x88CBB5CEB96B7BD2, ped, p1, action); } // 0x88CBB5CEB96B7BD2 0x67E28E1D
		...
		static void SET_PED_STRAFE_CLIPSET(Ped ped, const const char* clipSet) { invoke<Void>(0x29A28F3F8CF6D854, ped, clipSet); } // 0x29A28F3F8CF6D854 0x0BACF010
		static void RESET_PED_STRAFE_CLIPSET(Ped ped) { invoke<Void>(0x20510814175EA477, ped); } // 0x20510814175EA477 0xF1967A12
		static void SET_PED_WEAPON_MOVEMENT_CLIPSET(Ped ped, const const char* clipSet) { invoke<Void>(0x2622E35B77D3ACA2, ped, clipSet); } // 0x2622E35B77D3ACA2 0xF8BE54DC
		static void RESET_PED_WEAPON_MOVEMENT_CLIPSET(Ped ped) { invoke<Void>(0x97B0DB5B4AA74E77, ped); } // 0x97B0DB5B4AA74E77 0xC60C9ACD
		static void SET_PED_DRIVE_BY_CLIPSET_OVERRIDE(Ped ped, const const char* clipset) { invoke<Void>(0xED34AB6C5CB36520, ped, clipset); } // 0xED34AB6C5CB36520 0xD4C73595
		static void CLEAR_PED_DRIVE_BY_CLIPSET_OVERRIDE(Ped ped) { invoke<Void>(0x4AFE3690D7E0B5AC, ped); } // 0x4AFE3690D7E0B5AC 0xAEC9163B
		static void _SET_PED_COVER_CLIPSET_OVERRIDE(Ped ped, const const char* clipset) { invoke<Void>(0x9DBA107B4937F809, ped, clipset); } // 0x9DBA107B4937F809
		...
		static BOOL IS_SCRIPTED_SCENARIO_PED_USING_CONDITIONAL_ANIM(Ped ped, const const char* animDict, const const char* anim) { return invoke<BOOL>(0x6EC47A344923E1ED, ped, animDict, anim); } // 0x6EC47A344923E1ED 0x3C30B447
		static void SET_PED_ALTERNATE_WALK_ANIM(Ped ped, const const char* animDict, const const char* animName, float p3, BOOL p4) { invoke<Void>(0x6C60394CB4F75E9A, ped, animDict, animName, p3, p4); } // 0x6C60394CB4F75E9A 0x895E1D67
		...
		static void SET_PED_ALTERNATE_MOVEMENT_ANIM(Ped ped, int stance, const const char* animDictionary, const const char* animationName, float p4, BOOL p5) { invoke<Void>(0x90A43CC281FFAB46, ped, stance, animDictionary, animationName, p4, p5); } // 0x90A43CC281FFAB46 0xBA84FD8C
		...
		static void SET_PED_GESTURE_GROUP(Ped ped, const const char* animGroupGesture) { invoke<Void>(0xDDF803377F94AAA8, ped, animGroupGesture); } // 0xDDF803377F94AAA8 0x170DA109
		static Vector3 GET_ANIM_INITIAL_OFFSET_POSITION(const char* animDict, const const char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return invoke<Vector3>(0xBE22B26DD764C040, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } // 0xBE22B26DD764C040 0xC59D4268
		static Vector3 GET_ANIM_INITIAL_OFFSET_ROTATION(const char* animDict, const const char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return invoke<Vector3>(0x4B805E6046EE9E47, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } // 0x4B805E6046EE9E47 0x5F7789E6
		...
		static void SET_PED_NAME_DEBUG(Ped ped, const const char* name) { invoke<Void>(0x98EFA132A4117BE1, ped, name); } // 0x98EFA132A4117BE1 0x20D6273E
		...
		static void APPLY_PED_BLOOD(Ped ped, int boneIndex, float xRot, float yRot, float zRot, const const char* woundType) { invoke<Void>(0x83F7E01C7B769A26, ped, boneIndex, xRot, yRot, zRot, woundType); } // 0x83F7E01C7B769A26 0x376CE3C0
		...
		static void APPLY_PED_BLOOD_SPECIFIC(Ped ped, Any p1, float xOffset, float yOffset, float zOffset, float scale, Any p6, float p7, const const char* bloodType) { invoke<Void>(0xEF0D582CBF2D9B0F, ped, p1, xOffset, yOffset, zOffset, scale, p6, p7, bloodType); } // 0xEF0D582CBF2D9B0F 0xFC13CE80
		static void APPLY_PED_DAMAGE_DECAL(Ped ped, int damageZone, float xOffset, float yOffset, float zOffset, float scale, float alpha, int variation, BOOL fadeIn, const const char* decalName) { invoke<Void>(0x397C38AA7B4A5F83, ped, damageZone, xOffset, yOffset, zOffset, scale, alpha, variation, fadeIn, decalName); } // 0x397C38AA7B4A5F83 0x8A13A41F
		static void APPLY_PED_DAMAGE_PACK(Ped ped, const const char* damagePack, float damage, float mult) { invoke<Void>(0x46DF918788CB093F, ped, damagePack, damage, mult); } // 0x46DF918788CB093F 0x208D0CB8
		...
		static void CLEAR_PED_DAMAGE_DECAL_BY_ZONE(Ped ped, int p1, const const char* p2) { invoke<Void>(0x523C79AEEFCC4A2A, ped, p1, p2); } // 0x523C79AEEFCC4A2A 0x70AA5B7D
		...
		static BOOL IS_PED_USING_SCENARIO(Ped ped, const const char* scenario) { return invoke<BOOL>(0x1BF094736DD62C2E, ped, scenario); } // 0x1BF094736DD62C2E 0x0F65B0D4
		...
		static void PLAY_FACIAL_ANIM(Ped ped, const const char* animName, const const char* animDict) { invoke<Void>(0xE1E65CA8AC9C00ED, ped, animName, animDict); } // 0xE1E65CA8AC9C00ED 0x1F6CCDDE
		static void SET_FACIAL_IDLE_ANIM_OVERRIDE(Ped ped, const const char* animName, const const char* animDict) { invoke<Void>(0xFFC24B988B938B38, ped, animName, animDict); } // 0xFFC24B988B938B38 0x9BA19C13
		...
		static void SET_PED_COWER_HASH(Ped ped, const const char* p1) { invoke<Void>(0xA549131166868ED3, ped, p1); } // 0xA549131166868ED3 0x16F30DF4
		...
		static void SET_PED_USING_ACTION_MODE(Ped ped, BOOL state, int timeout, const const char* action) { invoke<Void>(0xD75ACCF5E0FB5367, ped, state, timeout, action); } // 0xD75ACCF5E0FB5367 0x8802F696
		static void _0x781DE8FA214E87D2(Ped ped, const const char* p1) { invoke<Void>(0x781DE8FA214E87D2, ped, p1); } // 0x781DE8FA214E87D2
		...
		static const const char* GET_PEDHEADSHOT_TXD_STRING(int handle) { return invoke<char*>(0xDB4EACD4AD0A5D6B, handle); } // 0xDB4EACD4AD0A5D6B 0x76D28E96
	...
	namespace VEHICLE
	{
		...
		static void SET_VEHICLE_NUMBER_PLATE_TEXT(Vehicle vehicle, const const char* plateText) { invoke<Void>(0x95A88F0B409CDA47, vehicle, plateText); } // 0x95A88F0B409CDA47 0x400F9556
		static const const char* GET_VEHICLE_NUMBER_PLATE_TEXT(Vehicle vehicle) { return invoke<char*>(0x7CE1CCB9B293020E, vehicle); } // 0x7CE1CCB9B293020E 0xE8522D58
		...
		static int GET_VEHICLE_RECORDING_ID(int p0, const const char* p1) { return invoke<int>(0x21543C612379DB3C, p0, p1); } // 0x21543C612379DB3C 0x328D601D
		static void REQUEST_VEHICLE_RECORDING(int i, const const char* name) { invoke<Void>(0xAF514CABE74CBF15, i, name); } // 0xAF514CABE74CBF15 0x91AFEFD9
		...
		static Vector3 GET_POSITION_OF_VEHICLE_RECORDING_AT_TIME(int p0, float p1, const const char* p2) { return invoke<Vector3>(0xD242728AA6F0FBA2, p0, p1, p2); } // 0xD242728AA6F0FBA2 0x7178558D
		...
		static void START_PLAYBACK_RECORDED_VEHICLE(Vehicle vehicle, int p1, const const char* playback, BOOL p3) { invoke<Void>(0x3F878F92B3A7A071, vehicle, p1, playback, p3); } // 0x3F878F92B3A7A071 0xCF614CA8
		static void START_PLAYBACK_RECORDED_VEHICLE_WITH_FLAGS(Vehicle vehicle, Any p1, const const char* playback, Any p3, Any p4, Any p5) { invoke<Void>(0x7D80FD645D4DA346, vehicle, p1, playback, p3, p4, p5); } // 0x7D80FD645D4DA346 0x4E721AD2
		...
		static const const char* GET_DISPLAY_NAME_FROM_VEHICLE_MODEL(Hash modelHash) { return invoke<char*>(0xB215AAC32D25D019, modelHash); } // 0xB215AAC32D25D019 0xEC86DF39
		...
		static void SET_VEHICLE_NAME_DEBUG(Vehicle vehicle, const const char* name) { invoke<Void>(0xBFDF984E2C22B94F, vehicle, name); } // 0xBFDF984E2C22B94F 0xA712FF5C
		...
		static void _0xCAC66558B944DA67(const char* vehicle, BOOL p1) { invoke<Void>(0xCAC66558B944DA67, vehicle, p1); } // 0xCAC66558B944DA67 0x0B200CE2
		...
		static const const char* GET_VEHICLE_MOD_COLOR_1_NAME(Vehicle vehicle, BOOL p1) { return invoke<char*>(0xB45085B721EFD38C, vehicle, p1); } // 0xB45085B721EFD38C 0x9A0840FD
		static const const char* GET_VEHICLE_MOD_COLOR_2_NAME(Vehicle vehicle) { return invoke<char*>(0x4967A516ED23A5A1, vehicle); } // 0x4967A516ED23A5A1 0x9BDC0B49
		...
		static const const char* GET_MOD_TEXT_LABEL(Vehicle vehicle, int modType, int modValue) { return invoke<char*>(0x8935624F8C5592CC, vehicle, modType, modValue); } // 0x8935624F8C5592CC 0x0BA39CA7
		static const const char* GET_MOD_SLOT_NAME(Vehicle vehicle, int modType) { return invoke<char*>(0x51F0FEB9F6AE98C0, vehicle, modType); } // 0x51F0FEB9F6AE98C0 0x5E113483
		static const const char* GET_LIVERY_NAME(Vehicle vehicle, int liveryIndex) { return invoke<char*>(0xB4C7A93837C91A1F, vehicle, liveryIndex); } // 0xB4C7A93837C91A1F 0xED80B5BE
	...
	namespace OBJECT
	{
		...
		static int _GET_DES_OBJECT(float x, float y, float z, float rotation, const const char* name) { return invoke<int>(0xB48FCED898292E52, x, y, z, rotation, name); } // 0xB48FCED898292E52 0xA286DE96
	...
	namespace AI
	{
		...
		static void TASK_PLAY_ANIM(Ped ped, const const char* animDictionary, const const char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, BOOL lockX, BOOL lockY, BOOL lockZ) { invoke<Void>(0xEA47FE3719165B94, ped, animDictionary, animationName, speed, speedMultiplier, duration, flag, playbackRate, lockX, lockY, lockZ); } // 0xEA47FE3719165B94 0x5AB552C6
		static void TASK_PLAY_ANIM_ADVANCED(Ped ped, const const char* animDict, const const char* animName, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, float speed, float speedMultiplier, int duration, Any flag, float animTime, int p14, int p15) { invoke<Void>(0x83CDB10EA29B370B, ped, animDict, animName, posX, posY, posZ, rotX, rotY, rotZ, speed, speedMultiplier, duration, flag, animTime, p14, p15); } // 0x83CDB10EA29B370B 0x3DDEB0E6
		static void STOP_ANIM_TASK(Ped ped, const const char* animDictionary, const const char* animationName, float blendoutSpeed) { invoke<Void>(0x97FF36A1D40EA00A, ped, animDictionary, animationName, blendoutSpeed); } // 0x97FF36A1D40EA00A 0x2B520A57
		...
		static void TASK_PLAY_PHONE_GESTURE_ANIMATION(Ped ped, const const char* animDict, const const char* animation, const const char* boneMaskType, float p4, float p5, BOOL p6, BOOL p7) { invoke<Void>(0x8FBB6758B3B3E9EC, ped, animDict, animation, boneMaskType, p4, p5, p6, p7); } // 0x8FBB6758B3B3E9EC 0x1582162C
		...
		static void TASK_VEHICLE_PLAY_ANIM(Vehicle vehicle, const const char* animation_set, const const char* animation_name) { invoke<Void>(0x69F5C3BD0F3EBD89, vehicle, animation_set, animation_name); } // 0x69F5C3BD0F3EBD89 0x2B28F598
		...
		static const const char* GET_CLIP_SET_FOR_SCRIPTED_GUN_TASK(int p0) { return invoke<char*>(0x3A8CADC7D37AACC5, p0); } // 0x3A8CADC7D37AACC5 0x249EB4EB
		...
		static void TASK_STAND_GUARD(Ped ped, float x, float y, float z, float heading, const const char* scenarioName) { invoke<Void>(0xAE032F8BBA959E90, ped, x, y, z, heading, scenarioName); } // 0xAE032F8BBA959E90 0xD130F636
		...
		static void TASK_START_SCENARIO_IN_PLACE(Ped ped, const const char* scenarioName, int unkDelay, BOOL playEnterAnim) { invoke<Void>(0x142A02425FF02BD9, ped, scenarioName, unkDelay, playEnterAnim); } // 0x142A02425FF02BD9 0xE50D6DDE
		static void TASK_START_SCENARIO_AT_POSITION(Ped ped, const const char* scenarioName, float x, float y, float z, float heading, int duration, BOOL sittingScenario, BOOL teleport) { invoke<Void>(0xFA4EFC79F69D4F07, ped, scenarioName, x, y, z, heading, duration, sittingScenario, teleport); } // 0xFA4EFC79F69D4F07 0xAA2C4AC2
		...
		static BOOL DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA(float x, float y, float z, const const char* scenarioName, float radius, BOOL p5) { return invoke<BOOL>(0x0A9D0C2A3BBC86C1, x, y, z, scenarioName, radius, p5); } // 0x0A9D0C2A3BBC86C1 0x0FB138A5
		...
		static void PLAY_ANIM_ON_RUNNING_SCENARIO(Ped ped, const const char* animDict, const const char* animName) { invoke<Void>(0x748040460F8DF5DC, ped, animDict, animName); } // 0x748040460F8DF5DC 0x1984A5D1
		...
		static void ADD_PATROL_ROUTE_NODE(int p0, const const char* p1, float x1, float y1, float z1, float x2, float y2, float z2, int p8) { invoke<Void>(0x8EDF950167586B7C, p0, p1, x1, y1, z1, x2, y2, z2, p8); } // 0x8EDF950167586B7C 0x21B48F10
		...
		static void TASK_PATROL(Ped ped, const const char* p1, Any p2, BOOL p3, BOOL p4) { invoke<Void>(0xBDA5DF49D080FE4E, ped, p1, p2, p3, p4); } // 0xBDA5DF49D080FE4E 0xB92E5AF6
		...
		static void TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(Ped ped, Vehicle vehicle, const const char* WPRecording, int p3, int p4, int p5, int p6, float p7, BOOL p8, float p9) { invoke<Void>(0x3123FAA6DB1CF7ED, ped, vehicle, WPRecording, p3, p4, p5, p6, p7, p8, p9); } // 0x3123FAA6DB1CF7ED 0x959818B6
		...
		static void _TASK_MOVE_NETWORK(Ped ped, const const char* task, float multiplier, BOOL p3, const const char* animDict, int flags) { invoke<Void>(0x2D537BA194896636, ped, task, multiplier, p3, animDict, flags); } // 0x2D537BA194896636 0x6F5D215F
		static void _TASK_MOVE_NETWORK_ADVANCED(Ped ped, const const char* p1, float p2, float p3, float p4, float p5, float p6, float p7, Any p8, float p9, BOOL p10, const const char* animDict, int flags) { invoke<Void>(0xD5B35BEA41919ACB, ped, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, animDict, flags); } // 0xD5B35BEA41919ACB 0x71A5C5DB
		...
		static Any _SET_NETWORK_TASK_ACTION(Ped ped, const const char* p1) { return invoke<Any>(0xD01015C7316AE176, ped, p1); } // 0xD01015C7316AE176 0x885724DE
		static Any _0xAB13A5565480B6D9(Ped ped, const const char* unk) { return invoke<Any>(0xAB13A5565480B6D9, ped, unk); } // 0xAB13A5565480B6D9
		static const const char* _GET_PED_NETWORK_TASK_PHASE(Ped ped) { return invoke<char*>(0x717E4D1F2048376D, ped); } // 0x717E4D1F2048376D 0x96C0277B
		static void _SET_NETWORK_TASK_PARAM_FLOAT(Ped ped, const const char* p1, float p2) { invoke<Void>(0xD5BB4025AE449A4E, ped, p1, p2); } // 0xD5BB4025AE449A4E 0xA79BE783
		static void _SET_NETWORK_TASK_PARAM_BOOL(Ped ped, const const char* p1, BOOL p2) { invoke<Void>(0xB0A6CFD2C69C1088, ped, p1, p2); } // 0xB0A6CFD2C69C1088 0xF3538041
		static BOOL _0xA7FFBA498E4AAF67(Ped ped, const const char* p1) { return invoke<BOOL>(0xA7FFBA498E4AAF67, ped, p1); } // 0xA7FFBA498E4AAF67 0x1EBB6F3D
		static BOOL _0xB4F47213DF45A64C(Ped ped, const const char* p1) { return invoke<BOOL>(0xB4F47213DF45A64C, ped, p1); } // 0xB4F47213DF45A64C 0x72FA5EF2
		...
		static void TASK_SYNCHRONIZED_SCENE(Ped ped, int scene, const const char* animDictionary, const const char* animationName, float speed, float speedMultiplier, int headingFlag, int flag, float playbackRate, Any p9) { invoke<Void>(0xEEA929141F699854, ped, scene, animDictionary, animationName, speed, speedMultiplier, headingFlag, flag, playbackRate, p9); } // 0xEEA929141F699854 0x4F217E7B
		static void TASK_SWEEP_AIM_ENTITY(Ped ped, const const char* animDict, const const char* animName1, const const char* animName2, const const char* animName3, int duration, Entity entity, float p7, float p8) { invoke<Void>(0x2047C02158D6405A, ped, animDict, animName1, animName2, animName3, duration, entity, p7, p8); } // 0x2047C02158D6405A 0x4D210467
		...
		static void TASK_SWEEP_AIM_POSITION(Ped ped, const const char* animDict, const const char* animName1, const const char* animName2, const const char* animName3, int timeout, float X, float Y, float Z, float unk, float flag) { invoke<Void>(0x7AFE8FDC10BC07D2, ped, animDict, animName1, animName2, animName3, timeout, X, Y, Z, unk, flag); } // 0x7AFE8FDC10BC07D2 0x1683FE66
	...
	namespace GAMEPLAY
	{
		...
		static const const char* _GET_GLOBAL_CHAR_BUFFER() { return invoke<char*>(0x24DA7D7667FD7B09); } // 0x24DA7D7667FD7B09
		static void _0x4DCDF92BF64236CD(const char* p0, const const char* p1) { invoke<Void>(0x4DCDF92BF64236CD, p0, p1); } // 0x4DCDF92BF64236CD
		...
		static void PRELOAD_CLOUD_HAT(const char* name) { invoke<Void>(0x11B56FBBF7224868, name); } // 0x11B56FBBF7224868 0x8727A4C5
		...
		static void UNLOAD_CLOUD_HAT(const char* name, float p1) { invoke<Void>(0xA74802FB8D0B7814, name, p1); } // 0xA74802FB8D0B7814 0xC9FA6E07
		...
		static BOOL ARE_STRINGS_EQUAL(const char* string1, const const char* string2) { return invoke<BOOL>(0x0C515FAB3FF9EA92, string1, string2); } // 0x0C515FAB3FF9EA92 0x877C0BC5
		static int COMPARE_STRINGS(const char* str1, const const char* str2, BOOL matchCase, int maxLength) { return invoke<int>(0x1E34710ECD4AB0EB, str1, str2, matchCase, maxLength); } // 0x1E34710ECD4AB0EB 0xFE25A58F
		...
		static void REGISTER_INT_TO_SAVE(Any* p0, const const char* name) { invoke<Void>(0x34C9EE5986258415, p0, name); } // 0x34C9EE5986258415 0xB930956F
		static void _0xA735353C77334EA0(Any* p0, Any* p1) { invoke<Void>(0xA735353C77334EA0, p0, p1); } // 0xA735353C77334EA0
		static void REGISTER_ENUM_TO_SAVE(Any* p0, const const char* name) { invoke<Void>(0x10C2FA78D0E128A1, p0, name); } // 0x10C2FA78D0E128A1 0x9B38374A
		static void REGISTER_FLOAT_TO_SAVE(Any* p0, const const char* name) { invoke<Void>(0x7CAEC29ECB5DFEBB, p0, name); } // 0x7CAEC29ECB5DFEBB 0xDB06F7AD
		static void REGISTER_BOOL_TO_SAVE(Any* p0, const const char* name) { invoke<Void>(0xC8F4131414C835A1, p0, name); } // 0xC8F4131414C835A1 0x5417E0E0
		static void REGISTER_TEXT_LABEL_TO_SAVE(Any* p0, const const char* name) { invoke<Void>(0xEDB1232C5BEAE62F, p0, name); } // 0xEDB1232C5BEAE62F 0x284352C4
		static void _0x6F7794F28C6B2535(Any* p0, const const char* name) { invoke<Void>(0x6F7794F28C6B2535, p0, name); } // 0x6F7794F28C6B2535 0xE2089749
		static void _0x48F069265A0E4BEC(Any* p0, const const char* name) { invoke<Void>(0x48F069265A0E4BEC, p0, name); } // 0x48F069265A0E4BEC 0xF91B8C33
		static void _0x8269816F6CFD40F8(Any* p0, const const char* name) { invoke<Void>(0x8269816F6CFD40F8, p0, name); } // 0x8269816F6CFD40F8 0x74E8FAD9
		static void _0xFAA457EF263E8763(Any* p0, const const char* name) { invoke<Void>(0xFAA457EF263E8763, p0, name); } // 0xFAA457EF263E8763 0x6B4335DD
		static void _START_SAVE_STRUCT(Any* p0, int p1, const const char* structName) { invoke<Void>(0xBF737600CDDBEADD, p0, p1, structName); } // 0xBF737600CDDBEADD 0xFB45728E
		static void STOP_SAVE_STRUCT() { invoke<Void>(0xEB1774DF12BB9F12); } // 0xEB1774DF12BB9F12 0xC2624A28
		static void _START_SAVE_ARRAY(Any* p0, int p1, const const char* arrayName) { invoke<Void>(0x60FE567DF1B1AF9D, p0, p1, arrayName); } // 0x60FE567DF1B1AF9D 0x893A342C
		...
		static void _0x54F157E0336A3822(Any p0, const const char* p1, float p2) { invoke<Void>(0x54F157E0336A3822, p0, p1, p2); } // 0x54F157E0336A3822 0x49F977A9
		...
		static void _DISPLAY_ONSCREEN_KEYBOARD_2(int p0, const const char* windowTitle, Any* p2, Player* defaultText, const const char* defaultConcat1, const const char* defaultConcat2, const const char* defaultConcat3, const const char* defaultConcat4, const const char* defaultConcat5, const const char* defaultConcat6, const const char* defaultConcat7, int maxInputLength) { invoke<Void>(0xCA78CFA0366592FE, p0, windowTitle, p2, defaultText, defaultConcat1, defaultConcat2, defaultConcat3, defaultConcat4, defaultConcat5, defaultConcat6, defaultConcat7, maxInputLength); } // 0xCA78CFA0366592FE 0xD2688412
		static void DISPLAY_ONSCREEN_KEYBOARD(int p0, const const char* windowTitle, const const char* p2, const const char* defaultText, const const char* defaultConcat1, const const char* defaultConcat2, const const char* defaultConcat3, int maxInputLength) { invoke<Void>(0x00DC833F2568DBF6, p0, windowTitle, p2, defaultText, defaultConcat1, defaultConcat2, defaultConcat3, maxInputLength); } // 0x00DC833F2568DBF6 0xAD99F2CE
		static int UPDATE_ONSCREEN_KEYBOARD() { return invoke<int>(0x0CF2B696BBF945AE); } // 0x0CF2B696BBF945AE 0x23D0A1CE
		static const const char* GET_ONSCREEN_KEYBOARD_RESULT() { return invoke<char*>(0x8362B09B91893647); } // 0x8362B09B91893647 0x44828FB3
	...
	namespace AUDIO
	{
		...
		static void ADD_LINE_TO_CONVERSATION(int p0, const const char* p1, const const char* p2, int p3, int p4, BOOL p5, BOOL p6, BOOL p7, BOOL p8, int p9, BOOL p10, BOOL p11, BOOL p12) { invoke<Void>(0xC5EF963405593646, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12); } // 0xC5EF963405593646 0x96CD0513
		static void ADD_PED_TO_CONVERSATION(int pedIndex, Ped ped, const const char* name) { invoke<Void>(0x95D9F4BC443956E7, pedIndex, ped, name); } // 0x95D9F4BC443956E7 0xF8D5EB86
		...
		static void INTERRUPT_CONVERSATION(Ped targ, const const char* gxtLine, const const char* charName) { invoke<Void>(0xA018A12E5C5C2FA6, targ, gxtLine, charName); } // 0xA018A12E5C5C2FA6 0xF3A67AF3
		static void _INTERRUPT_CONVERSATION_AND_PAUSE(Ped p0, const const char* p1, const const char* p2) { invoke<Void>(0x8A694D7A68F8DC38, p0, p1, p2); } // 0x8A694D7A68F8DC38
		...
		static void PLAY_SOUND(Player soundId, const const char* audioName, const const char* audioRef, BOOL p3, Any p4, BOOL p5) { invoke<Void>(0x7FF4944CC209192D, soundId, audioName, audioRef, p3, p4, p5); } // 0x7FF4944CC209192D 0xB6E1917F
		static void PLAY_SOUND_FRONTEND(int soundId, const const const char* audioName, const const const char* audioRef, BOOL p3) { invoke<Void>(0x67C540AA08E4A6F5, soundId, audioName, audioRef, p3); } // 0x67C540AA08E4A6F5 0x2E458F74
		static void _0xCADA5A0D0702381E(const char* p0, const const char* soundset) { invoke<Void>(0xCADA5A0D0702381E, p0, soundset); } // 0xCADA5A0D0702381E 0xC70E6CFA
		static void PLAY_SOUND_FROM_ENTITY(int soundId, const const char* audioName, Entity entity, const const char* audioRef, BOOL p4, Any p5) { invoke<Void>(0xE65F427EB70AB1ED, soundId, audioName, entity, audioRef, p4, p5); } // 0xE65F427EB70AB1ED 0x95AE00F8
		static void PLAY_SOUND_FROM_COORD(int soundId, const const char* audioName, float x, float y, float z, const const char* audioRef, BOOL p6, int range, BOOL p8) { invoke<Void>(0x8D8686B622B88120, soundId, audioName, x, y, z, audioRef, p6, range, p8); } // 0x8D8686B622B88120 0xCAD3E2D5
		...
		static void SET_VARIABLE_ON_SOUND(int soundId, const const char* variableName, float value) { invoke<Void>(0xAD6B3148A78AE9B6, soundId, variableName, value); } // 0xAD6B3148A78AE9B6 0x606EE5FA
		...
		static void _PLAY_AMBIENT_SPEECH1(Ped ped, const const char* speechName, const const char* speechParam) { invoke<Void>(0x8E04FEDD28D42462, ped, speechName, speechParam); } // 0x8E04FEDD28D42462 0x5C57B85D
		static void _PLAY_AMBIENT_SPEECH2(Ped ped, const const char* speechName, const const char* speechParam) { invoke<Void>(0xC6941B4A3A8FBBB9, ped, speechName, speechParam); } // 0xC6941B4A3A8FBBB9 0x444180DB
		static void _PLAY_AMBIENT_SPEECH_WITH_VOICE(Ped p0, const const char* speechName, const const char* voiceName, const const char* speechParam, BOOL p4) { invoke<Void>(0x3523634255FC3318, p0, speechName, voiceName, speechParam, p4); } // 0x3523634255FC3318 0x8386AE28
		static void _PLAY_AMBIENT_SPEECH_AT_COORDS(const char* speechName, const const char* voiceName, float x, float y, float z, const const char* speechParam) { invoke<Void>(0xED640017ED337E45, speechName, voiceName, x, y, z, speechParam); } // 0xED640017ED337E45 0xA1A1402E
		static void OVERRIDE_TREVOR_RAGE(const char* p0) { invoke<Void>(0x13AD665062541A7E, p0); } // 0x13AD665062541A7E 0x05B9B5CF
		...
		static void SET_AMBIENT_VOICE_NAME(Ped ped, const const char* name) { invoke<Void>(0x6C8065A3B780185B, ped, name); } // 0x6C8065A3B780185B 0xBD2EA1A1
		...
		static BOOL _CAN_PED_SPEAK(Ped ped, const const char* speechName, BOOL unk) { return invoke<BOOL>(0x49B99BF3FDA89A7A, ped, speechName, unk); } // 0x49B99BF3FDA89A7A 0x8BD5F11E
		...
		static void _PLAY_ANIMAL_VOCALIZATION(Entity entity, int unk, const const char* speech) { invoke<Void>(0xEE066C7006C49C0A, entity, unk, speech); } // 0xEE066C7006C49C0A 0x498849F3
		...
		static const const char* GET_PLAYER_RADIO_STATION_NAME() { return invoke<char*>(0xF6D733C32076AD03); } // 0xF6D733C32076AD03 0xD909C107
		static const const char* GET_RADIO_STATION_NAME(int radioStation) { return invoke<char*>(0xB28ECA15046CA8B9, radioStation); } // 0xB28ECA15046CA8B9 0x3DF493BC
		...
		static void SET_VEH_RADIO_STATION(Vehicle vehicle, const const char* radioStation) { invoke<Void>(0x1B9C0099CB942AC6, vehicle, radioStation); } // 0x1B9C0099CB942AC6 0xE391F55F
		...
		static void SET_EMITTER_RADIO_STATION(const char* emitterName, const const char* radioStation) { invoke<Void>(0xACF57305B12AF907, emitterName, radioStation); } // 0xACF57305B12AF907 0x87431585
		...
		static void SET_RADIO_TRACK(const char* radioStation, const const char* effectOrEvent) { invoke<Void>(0xB39786F201FEE30B, radioStation, effectOrEvent); } // 0xB39786F201FEE30B 0x76E96212
		...
		static void _SET_CUSTOM_RADIO_TRACK_LIST(const char* radioStation, const const char* trackList, BOOL b) { invoke<Void>(0x4E404A9361F75BB2, radioStation, trackList, b); } // 0x4E404A9361F75BB2 0x128C3873
		static void _CLEAR_CUSTOM_RADIO_TRACK_LIST(const char* radioStation) { invoke<Void>(0x1654F24A88A8E3FE, radioStation); } // 0x1654F24A88A8E3FE 0x1D766976
		...
		static void _SET_RADIO_STATION_MUSIC_ONLY(const char* radioStation, BOOL p1) { invoke<Void>(0x774BD811F656A122, radioStation, p1); } // 0x774BD811F656A122 0xB1FF7137
		static void _0x2C96CDB04FCA358E(float p0) { invoke<Void>(0x2C96CDB04FCA358E, p0); } // 0x2C96CDB04FCA358E 0xC8B514E2
		static void _0x031ACB6ABA18C729(const char* radioStation, const const char* p1) { invoke<Void>(0x031ACB6ABA18C729, radioStation, p1); } // 0x031ACB6ABA18C729 0xBE998184
		...
		static void SET_AMBIENT_ZONE_LIST_STATE(const char* p0, BOOL p1, BOOL p2) { invoke<Void>(0x9748FA4DE50CCE3E, p0, p1, p2); } // 0x9748FA4DE50CCE3E 0xBF80B412
		...
		static BOOL LOAD_STREAM(const char* streamName, const const char* soundSet) { return invoke<BOOL>(0x1F1F957154EC51DF, streamName, soundSet); } // 0x1F1F957154EC51DF 0x0D89599D
		static BOOL LOAD_STREAM_WITH_START_OFFSET(const char* streamName, int startOffset, const const char* soundSet) { return invoke<BOOL>(0x59C16B79F53B3712, streamName, startOffset, soundSet); } // 0x59C16B79F53B3712 0xE5B5745C
		...
		static void _FORCE_VEHICLE_ENGINE_AUDIO(Vehicle vehicle, const const char* audioName) { invoke<Void>(0x4F0C413926060B38, vehicle, audioName); } // 0x4F0C413926060B38 0x33B0B007
		static void _0xF1F8157B8C3F171C(Any p0, const const char* p1, const const char* p2) { invoke<Void>(0xF1F8157B8C3F171C, p0, p1, p2); } // 0xF1F8157B8C3F171C 0x1C0C5E4C
		...
		static void SET_AUDIO_SCENE_VARIABLE(const char* scene, const const char* variable, float value) { invoke<Void>(0xEF21A9EF089A2668, scene, variable, value); } // 0xEF21A9EF089A2668 0x19BB3CE8
		static void _0xA5F377B175A699C5(Any p0) { invoke<Void>(0xA5F377B175A699C5, p0); } // 0xA5F377B175A699C5 0xE812925D
		static void _DYNAMIC_MIXER_RELATED_FN(Entity p0, const const char* p1, float p2) { invoke<Void>(0x153973AB99FE8980, p0, p1, p2); } // 0x153973AB99FE8980 0x2BC93264
		...
		static Any PREPARE_SYNCHRONIZED_AUDIO_EVENT(const char* audioName, BOOL unk) { return invoke<Any>(0xC7ABCACA4985A766, audioName, unk); } // 0xC7ABCACA4985A766 0xE1D91FD0
		static BOOL PREPARE_SYNCHRONIZED_AUDIO_EVENT_FOR_SCENE(int SceneID, const const char* audioName) { return invoke<BOOL>(0x029FE7CD1B7E2E75, SceneID, audioName); } // 0x029FE7CD1B7E2E75 0x7652DD49
		...
		static void _0x044DBAD7A7FA2BE5(const char* p0, const const char* p1) { invoke<Void>(0x044DBAD7A7FA2BE5, p0, p1); } // 0x044DBAD7A7FA2BE5 0x8AD670EC
	...
	namespace CUTSCENE
	{
		static void REQUEST_CUTSCENE(const char* cutsceneName, int id) { invoke<Void>(0x7A86743F475D9E09, cutsceneName, id); } // 0x7A86743F475D9E09 0xB5977853
		...
		static void REGISTER_ENTITY_FOR_CUTSCENE(Ped cutscenePed, const const char* cutsceneEntName, int p2, Hash modelHash, int p4) { invoke<Void>(0xE40C1C56DF95C2E8, cutscenePed, cutsceneEntName, p2, modelHash, p4); } // 0xE40C1C56DF95C2E8 0x7CBC3EC7
	...
	namespace INTERIOR
	{
		...
		static void ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(Pickup pickup, const const char* roomName) { invoke<Void>(0x3F6167F351168730, pickup, roomName); } // 0x3F6167F351168730 0xA2A73564
		...
		static int GET_INTERIOR_AT_COORDS_WITH_TYPE(float x, float y, float z, const const char* interiorType) { return invoke<int>(0x05B7A89BD78797FC, x, y, z, interiorType); } // 0x05B7A89BD78797FC 0x96525B06
		...
		static void _ENABLE_INTERIOR_PROP(int interiorID, const const char* propName) { invoke<Void>(0x55E86AF2712B36A1, interiorID, propName); } // 0x55E86AF2712B36A1 0xC80A5DDF
		static void _DISABLE_INTERIOR_PROP(int interiorID, const const char* propName) { invoke<Void>(0x420BD37289EEE162, interiorID, propName); } // 0x420BD37289EEE162 0xDBA768A1
		static BOOL _IS_INTERIOR_PROP_ENABLED(int interiorID, const const char* propName) { return invoke<BOOL>(0x35F7DD45E8C0A16D, interiorID, propName); } // 0x35F7DD45E8C0A16D 0x39A3CC6F
	...
	namespace CAM
	{
		...
		static Cam CREATE_CAM(const char* camName, BOOL unk) { return invoke<Cam>(0xC3981DCE61D9E13F, camName, unk); } // 0xC3981DCE61D9E13F 0xE9BF2A7D
		...
		static void SET_CAM_DEBUG_NAME(Cam camera, const const char* name) { invoke<Void>(0x1B93E0107865DD40, camera, name); } // 0x1B93E0107865DD40 0x9B00DF3F
		...
		static void SHAKE_CAM(Cam cam, const const char* type, float amplitude) { invoke<Void>(0x6A25241C340D3822, cam, type, amplitude); } // 0x6A25241C340D3822 0x1D4211B0
		static void ANIMATED_SHAKE_CAM(Cam cam, const const char* p1, const const char* p2, const const char* p3, float amplitude) { invoke<Void>(0xA2746EEAE3E577CD, cam, p1, p2, p3, amplitude); } // 0xA2746EEAE3E577CD 0xE1168767
		...
		static void _0xC2EAE3FB8CDBED31(const char* p0, const const char* p1, const const char* p2, float p3) { invoke<Void>(0xC2EAE3FB8CDBED31, p0, p1, p2, p3); } // 0xC2EAE3FB8CDBED31 0xCB75BD9C
		...
		static BOOL PLAY_CAM_ANIM(Cam cam, const const char* animName, const const char* animDictionary, float x, float y, float z, float xRot, float yRot, float zRot, BOOL p9, int p10) { return invoke<BOOL>(0x9A2D0FB2E7852392, cam, animName, animDictionary, x, y, z, xRot, yRot, zRot, p9, p10); } // 0x9A2D0FB2E7852392 0xBCEFB87E
		static BOOL IS_CAM_PLAYING_ANIM(Cam cam, const const char* animName, const const char* animDictionary) { return invoke<BOOL>(0xC90621D8A0CEECF2, cam, animName, animDictionary); } // 0xC90621D8A0CEECF2 0xB998CB49
		...
		static BOOL PLAY_SYNCHRONIZED_CAM_ANIM(Cam camera, int SceneID, const const char* animName, const const char* animDictionary) { return invoke<BOOL>(0xE32EFE9AB4A9AA0C, camera, SceneID, animName, animDictionary); } // 0xE32EFE9AB4A9AA0C 0x9458459E
	...
	namespace STREAMING
	{
		...
		static void _REQUEST_INTERIOR_ROOM_BY_NAME(int interiorID, const const char* roomName) { invoke<Void>(0x8A7A40100EDFEC58, interiorID, roomName); } // 0x8A7A40100EDFEC58 0x939243FB
		...
		static BOOL HAS_NAMED_PTFX_ASSET_LOADED(const char* assetName) { return invoke<BOOL>(0x8702416E512EC454, assetName); } // 0x8702416E512EC454 0x9ACC6446
		static void _REMOVE_NAMED_PTFX_ASSET(const char* assetName) { invoke<Void>(0x5F61EBBE1A00F96D, assetName); } // 0x5F61EBBE1A00F96D
		...
		static void _SET_MAPDATACULLBOX_ENABLED(const char* p0, BOOL p1) { invoke<Void>(0xAF12610C644A35C9, p0, p1); } // 0xAF12610C644A35C9 0x403CD434
		...
		static void _0x0FDE9DBFC0A6BC65(const char* p0) { invoke<Void>(0x0FDE9DBFC0A6BC65, p0); } // 0x0FDE9DBFC0A6BC65 0x279077B0
	...
	namespace SCRIPT
	{
		...
		static const const char* _GET_NAME_OF_THREAD(int threadId) { return invoke<char*>(0x05A42BA9FC8DA96B, threadId); } // 0x05A42BA9FC8DA96B 0xBE7ACD89
		...
		static const const char* GET_THIS_SCRIPT_NAME() { return invoke<char*>(0x442E0A7EDE4A738A); } // 0x442E0A7EDE4A738A 0xA40FD5D9
	...
	namespace UI
	{
		static void BEGIN_TEXT_COMMAND_BUSYSPINNER_ON(const char* string) { invoke<Void>(0xABA17D7CE615ADBF, string); } // 0xABA17D7CE615ADBF 0xCB7C8994
		...
		static int _SET_NOTIFICATION_MESSAGE(const char* picName1, const const char* picName2, BOOL flash, int iconType, BOOL _nonExistent, const const char* sender, const const char* subject) { return invoke<int>(0x2B7E9A4EAAA93C89, picName1, picName2, flash, iconType, _nonExistent, sender, subject); } // 0x2B7E9A4EAAA93C89 0xED130FA1
		static int _SET_NOTIFICATION_MESSAGE_2(const char* picName1, const const char* picName2, BOOL flash, int iconType, const const char* sender, const const char* subject) { return invoke<int>(0x1CCD9A37359072CF, picName1, picName2, flash, iconType, sender, subject); } // 0x1CCD9A37359072CF 0xE7E3C98B
		static int _SET_NOTIFICATION_MESSAGE_3(const char* picName1, const const char* picName2, BOOL p2, Any p3, const const char* p4, const const char* p5) { return invoke<int>(0xC6F580E4C94926AC, picName1, picName2, p2, p3, p4, p5); } // 0xC6F580E4C94926AC
		static int _SET_NOTIFICATION_MESSAGE_4(const char* picName1, const const char* picName2, BOOL flash, int iconType, const const char* sender, const const char* subject, float duration) { return invoke<int>(0x1E6611149DB3DB6B, picName1, picName2, flash, iconType, sender, subject, duration); } // 0x1E6611149DB3DB6B 0x0EB382B7
		static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG(const char* picName1, const const char* picName2, BOOL flash, int iconType, const const char* sender, const const char* subject, float duration, const const char* clanTag) { return invoke<int>(0x5CBF7BADE20DB93E, picName1, picName2, flash, iconType, sender, subject, duration, clanTag); } // 0x5CBF7BADE20DB93E 0x3E807FE3
		static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(const char* picName1, const const char* picName2, BOOL flash, int iconType1, const const char* sender, const const char* subject, float duration, const const char* clanTag, int iconType2, int p9) { return invoke<int>(0x531B84E7DA981FB6, picName1, picName2, flash, iconType1, sender, subject, duration, clanTag, iconType2, p9); } // 0x531B84E7DA981FB6 0xDEB491C8
		...
		static int _DRAW_NOTIFICATION_AWARD(const char* p0, const const char* p1, int p2, int p3, const const char* p4) { return invoke<int>(0xAA295B6F28BD587D, p0, p1, p2, p3, p4); } // 0xAA295B6F28BD587D 0x02DED2B8
		...
		static int END_TEXT_COMMAND_THEFEED_POST_CREWTAG_WITH_GAME_NAME(BOOL p0, BOOL p1, int* p2, int p3, BOOL isLeader, BOOL unk0, int clanDesc, const const char* playerName, int R, int G, int B) { return invoke<int>(0x137BC35589E34E1E, p0, p1, p2, p3, isLeader, unk0, clanDesc, playerName, R, G, B); } // 0x137BC35589E34E1E 0x88B9B909
		static int _DRAW_NOTIFICATION_UNLOCK(const char* unlockLabel, int iconType, const const char* unk2) { return invoke<int>(0x33EE12743CCD6343, unlockLabel, iconType, unk2); } // 0x33EE12743CCD6343 0xE05E7052
		static int _DRAW_NOTIFICATION_UNLOCK_2(const char* unlockLabel, int iconType, const const char* unk2, int fadeInTime) { return invoke<int>(0xC8F3AAF93D0600BF, unlockLabel, iconType, unk2, fadeInTime); } // 0xC8F3AAF93D0600BF 0x4FA43BA4
		static int END_TEXT_COMMAND_THEFEED_POST_UNLOCK_TU_WITH_COLOR(const char* primaryText, int iconType, const const char* unk2, int fadeInTime, int primaryStyle, BOOL ignoreLoc) { return invoke<int>(0x7AE0589093A2E088, primaryText, iconType, unk2, fadeInTime, primaryStyle, ignoreLoc); } // 0x7AE0589093A2E088 0x8C90D22F
		...
		static int _DRAW_NOTIFICATION_WITH_ICON(int type, int image, const const char* text) { return invoke<int>(0xD202B92CBF1D816F, type, image, text); } // 0xD202B92CBF1D816F
		static int _DRAW_NOTIFICATION_WITH_BUTTON(int type, const const char* button, const const char* text) { return invoke<int>(0xDD6CB2CCE7C2735C, type, button, text); } // 0xDD6CB2CCE7C2735C
		...
		static void BEGIN_TEXT_COMMAND_DISPLAY_TEXT(const const const char* text) { invoke<Void>(0x25FBB336DF1804CB, text); } // 0x25FBB336DF1804CB 0x3E35563E
		...
		static void BEGIN_TEXT_COMMAND_OVERRIDE_BUTTON_TEXT(const char* p0) { invoke<Void>(0x8F9EE5687F8EECCD, p0); } // 0x8F9EE5687F8EECCD 0xBF855650
		...
		static void ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(const const const char* text) { invoke<Void>(0x6C188BE134E074AA, text); } // 0x6C188BE134E074AA 0x27A244D8
		...
		static void ADD_TEXT_COMPONENT_SUBSTRING_PHONE_NUMBER(const char* p0, int p1) { invoke<Void>(0x761B77454205A61D, p0, p1); } // 0x761B77454205A61D 0x65E1D404
		...
		static void ADD_TEXT_COMPONENT_SUBSTRING_KEYBOARD_DISPLAY(const char* p0) { invoke<Void>(0x5F68520888E69014, p0); } // 0x5F68520888E69014 0x0829A799
		...
		static const const char* _GET_TEXT_SUBSTRING(const char* text, int position, int length) { return invoke<char*>(0x169BD9382084C8C0, text, position, length); } // 0x169BD9382084C8C0 0x34A396EE
		static const const char* _GET_TEXT_SUBSTRING_SAFE(const char* text, int position, int length, int maxLength) { return invoke<char*>(0xB2798643312205C5, text, position, length, maxLength); } // 0xB2798643312205C5 0x0183A66C
		static const const char* _GET_TEXT_SUBSTRING_SLICE(const char* text, int startPosition, int endPosition) { return invoke<char*>(0xCE94AEBA5D82908A, text, startPosition, endPosition); } // 0xCE94AEBA5D82908A 0xFA6373BB
		static const const char* _GET_LABEL_TEXT(const char* labelName) { return invoke<char*>(0x7B5280EBA9840C72, labelName); } // 0x7B5280EBA9840C72 0x95C4B5AD
		...
		static const const char* GET_STREET_NAME_FROM_HASH_KEY(Hash hash) { return invoke<char*>(0xD0EF8A959B8A4CB9, hash); } // 0xD0EF8A959B8A4CB9 0x1E8E310C
		...
		static void SET_BLIP_NAME_FROM_TEXT_FILE(Blip blip, const const char* gxtEntry) { invoke<Void>(0xEAA0FFE120D92784, blip, gxtEntry); } // 0xEAA0FFE120D92784 0xAC8A5461
		...
		static void SET_MISSION_NAME(BOOL p0, const const char* name) { invoke<Void>(0x5F28ECF5FC84772F, p0, name); } // 0x5F28ECF5FC84772F 0x68DCAE10
		static void _SET_MISSION_NAME_2(BOOL p0, const const char* name) { invoke<Void>(0xE45087D85F468BC2, p0, name); } // 0xE45087D85F468BC2 0x8D9A1734
		...
		static void _SET_MP_GAMER_TAG_COLOR(int headDisplayId, const const char* username, BOOL pointedClanTag, BOOL isRockstarClan, const const char* clanTag, Any p5, int r, int g, int b) { invoke<Void>(0x6DD05E9D83EFA4C9, headDisplayId, username, pointedClanTag, isRockstarClan, clanTag, p5, r, g, b); } // 0x6DD05E9D83EFA4C9 0xC969F2D0
		static BOOL IS_MP_GAMER_TAG_MOVIE_ACTIVE() { return invoke<BOOL>(0x6E0EB3EB47C8D7AA); } // 0x6E0EB3EB47C8D7AA 0xEFD2564A
		static int CREATE_FAKE_MP_GAMER_TAG(Ped ped, const const char* username, BOOL pointedClanTag, BOOL isRockstarClan, const const char* clanTag, Any p5) { return invoke<int>(0xBFEFE3321A3F5015, ped, username, pointedClanTag, isRockstarClan, clanTag, p5); } // 0xBFEFE3321A3F5015 0xF5CD2AA4
		...
		static void SET_MP_GAMER_TAG_NAME(int gamerTagId, const const char* string) { invoke<Void>(0xDEA2B8283BAA3944, gamerTagId, string); } // 0xDEA2B8283BAA3944 0x627A559B
		...
		static void _SET_MP_GAMER_TAG_CHATTING(int gamerTagId, const const char* string) { invoke<Void>(0x7B7723747CCB55B6, gamerTagId, string); } // 0x7B7723747CCB55B6 0x939218AB
		...
		static void SET_WARNING_MESSAGE(const char* entryLine1, int instructionalKey, const const char* entryLine2, BOOL p3, Any p4, Any* p5, Any* p6, BOOL background) { invoke<Void>(0x7B1776B3B53F8D74, entryLine1, instructionalKey, entryLine2, p3, p4, p5, p6, background); } // 0x7B1776B3B53F8D74 0xBE699BDE
		static void SET_WARNING_MESSAGE_WITH_HEADER(const char* entryHeader, const const char* entryLine1, int instructionalKey, const const char* entryLine2, BOOL p4, Any p5, Any* p6, Any* p7, BOOL background) { invoke<Void>(0xDC38CC1E35B6A5D7, entryHeader, entryLine1, instructionalKey, entryLine2, p4, p5, p6, p7, background); } // 0xDC38CC1E35B6A5D7 0x2DB9EAB5
		static void _SET_WARNING_MESSAGE_3(const char* entryHeader, const const char* entryLine1, Any instructionalKey, const const char* entryLine2, BOOL p4, Any p5, Any p6, Any* p7, Any* p8, BOOL p9) { invoke<Void>(0x701919482C74B5AB, entryHeader, entryLine1, instructionalKey, entryLine2, p4, p5, p6, p7, p8, p9); } // 0x701919482C74B5AB 0x749929D3
		static BOOL _CREATE_DRAW_LIST(Any p0, const const char* text, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0x0C5A80A9E096D529, p0, text, p2, p3, p4, p5); } // 0x0C5A80A9E096D529
	...
	namespace GRAPHICS
	{
		...
		static BOOL _0x4862437A486F91B0(const char* p0, Any* p1, Any* p2, BOOL p3) { return invoke<BOOL>(0x4862437A486F91B0, p0, p1, p2, p3); } // 0x4862437A486F91B0 0x56C1E488
		...
		static void DRAW_MARKER(int type, float posX, float posY, float posZ, float dirX, float dirY, float dirZ, float rotX, float rotY, float rotZ, float scaleX, float scaleY, float scaleZ, int red, int green, int blue, int alpha, BOOL bobUpAndDown, BOOL faceCamera, int p19, BOOL rotate, const const char* textureDict, const const char* textureName, BOOL drawOnEnts) { invoke<Void>(0x28477EC23D892089, type, posX, posY, posZ, dirX, dirY, dirZ, rotX, rotY, rotZ, scaleX, scaleY, scaleZ, red, green, blue, alpha, bobUpAndDown, faceCamera, p19, rotate, textureDict, textureName, drawOnEnts); } // 0x28477EC23D892089 0x48D84A02
		...
		static void REQUEST_STREAMED_TEXTURE_DICT(const const const char* textureDict, BOOL unused) { invoke<Void>(0xDFA2EF8E04127DD5, textureDict, unused); } // 0xDFA2EF8E04127DD5 0x4C9B035F
		static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(const const const char* textureDict) { return invoke<BOOL>(0x0145F696AAAAD2E4, textureDict); } // 0x0145F696AAAAD2E4 0x3F436EEF
		...
		static void DRAW_SPRITE(const char* textureDict, const const char* textureName, float screenX, float screenY, float width, float height, float heading, int red, int green, int blue, int alpha) { invoke<Void>(0xE7FFAE5EBF23D890, textureDict, textureName, screenX, screenY, width, height, heading, red, green, blue, alpha); } // 0xE7FFAE5EBF23D890 0x1FEC16B0
		static void DRAW_SPRITE2(const const const char* textureDict, const const const char* textureName, float screenX, float screenY, float width, float height, float heading, int red, int green, int blue, int alpha) { invoke<Void>(0xE7FFAE5EBF23D890, textureDict, textureName, screenX, screenY, width, height, heading, red, green, blue, alpha); } // 0xE7FFAE5EBF23D890 0x1FEC16B0
		static Any ADD_ENTITY_ICON(Entity entity, const const char* icon) { return invoke<Any>(0x9CD43EEE12BF4DD0, entity, icon); } // 0x9CD43EEE12BF4DD0 0xF3027D21
		...
		static Vector3 GET_TEXTURE_RESOLUTION(const char* textureDict, const const char* textureName) { return invoke<Vector3>(0x35736EE65BD00C11, textureDict, textureName); } // 0x35736EE65BD00C11 0x096DAA4D
		...
		static BOOL START_NETWORKED_PARTICLE_FX_NON_LOOPED_AT_COORD(const char* effectName, float xPos, float yPos, float zPos, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<BOOL>(0xF56B8137DF10135D, effectName, xPos, yPos, zPos, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0xF56B8137DF10135D 0x633F8C48
		...
		static void SET_PARTICLE_FX_LOOPED_EVOLUTION(int ptfxHandle, const const char* propertyName, float amount, BOOL Id) { invoke<Void>(0x5F0C4B5B1C393BE2, ptfxHandle, propertyName, amount, Id); } // 0x5F0C4B5B1C393BE2 0x1CBC1373
		...
		static void USE_PARTICLE_FX_ASSET(const char* name) { invoke<Void>(0x6C38AF3693A69A91, name); } // 0x6C38AF3693A69A91 0x9C720B61
		static void _SET_PARTICLE_FX_ASSET_OLD_TO_NEW(const char* oldAsset, const const char* newAsset) { invoke<Void>(0xEA1E2D93F6F75ED9, oldAsset, newAsset); } // 0xEA1E2D93F6F75ED9
		...
		static void _OVERRIDE_DECAL_TEXTURE(int decalType, const const char* textureDict, const const char* textureName) { invoke<Void>(0x8A35C742130C6080, decalType, textureDict, textureName); } // 0x8A35C742130C6080 0x335695CF
		...
		static void _PRESET_INTERIOR_AMBIENT_CACHE(const char* tcModifierName) { invoke<Void>(0xD7021272EB0A451E, tcModifierName); } // 0xD7021272EB0A451E
		...
		static void _SET_TIMECYCLE_MODIFIER2(const char* p0) { invoke<Void>(0x5096FD9CCB49056D, p0); } // 0x5096FD9CCB49056D 0x908A335E
		...
		static void CALL_SCALEFORM_MOVIE_METHOD(int scaleform, const const char* method) { invoke<Void>(0xFBD96D87AC96D533, scaleform, method); } // 0xFBD96D87AC96D533 0x7AB77B57
		static void _CALL_SCALEFORM_MOVIE_FUNCTION_FLOAT_PARAMS(int scaleform, const const char* functionName, float param1, float param2, float param3, float param4, float param5) { invoke<Void>(0xD0837058AE2E4BEE, scaleform, functionName, param1, param2, param3, param4, param5); } // 0xD0837058AE2E4BEE 0x557EDA1D
		static void _CALL_SCALEFORM_MOVIE_FUNCTION_STRING_PARAMS(int scaleform, const const char* functionName, const const char* param1, const const char* param2, const const char* param3, const const char* param4, const const char* param5) { invoke<Void>(0x51BC1ED3CC44E8F7, scaleform, functionName, param1, param2, param3, param4, param5); } // 0x51BC1ED3CC44E8F7 0x91A7FCEB
		static void _CALL_SCALEFORM_MOVIE_FUNCTION_MIXED_PARAMS(int scaleform, const const char* functionName, float floatParam1, float floatParam2, float floatParam3, float floatParam4, float floatParam5, const const char* stringParam1, const const char* stringParam2, const const char* stringParam3, const const char* stringParam4, const const char* stringParam5) { invoke<Void>(0xEF662D8D57E290B1, scaleform, functionName, floatParam1, floatParam2, floatParam3, floatParam4, floatParam5, stringParam1, stringParam2, stringParam3, stringParam4, stringParam5); } // 0xEF662D8D57E290B1 0x6EAF56DE
		static BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_HUD_COMPONENT(int hudComponent, const const char* functionName) { return invoke<BOOL>(0x98C494FD5BDFBFD5, hudComponent, functionName); } // 0x98C494FD5BDFBFD5 0x5D66CE1E
		static BOOL BEGIN_SCALEFORM_MOVIE_METHOD(int scaleform, const const char* functionName) { return invoke<BOOL>(0xF6E48914C7A8694E, scaleform, functionName); } // 0xF6E48914C7A8694E 0x215ABBE8
		static BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_N(const char* functionName) { return invoke<BOOL>(0xAB58C27C2E6123C6, functionName); } // 0xAB58C27C2E6123C6 0xF6015178
		static BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_V(const char* functionName) { return invoke<BOOL>(0xB9449845F73F5E9C, functionName); } // 0xB9449845F73F5E9C 0x5E219B67
		...
		static const const char* SITTING_TV(int method_return) { return invoke<char*>(0xE1E258829A885245, method_return); } // 0xE1E258829A885245 0x516862EB
		...
		static void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BUTTON_NAME(const char* button) { invoke<Void>(0xE83A3E3557A56640, button); } // 0xE83A3E3557A56640 0xCCBF0334
		...
		static void SET_TV_CHANNEL_PLAYLIST(int channel, const const char* playlist, BOOL fromBeginning) { invoke<Void>(0xF7B38B8305F1FE8B, channel, playlist, fromBeginning); } // 0xF7B38B8305F1FE8B 0xB262DE67
		static void _0x2201C576FACAEBE8(Any p0, const const char* p1, Any p2) { invoke<Void>(0x2201C576FACAEBE8, p0, p1, p2); } // 0x2201C576FACAEBE8 0x78C4DCBE
		...
		static BOOL _DRAW_SHOWROOM(const char* p0, Ped ped, int p2, float posX, float posY, float posZ) { return invoke<BOOL>(0x98C4FE6EC34154CA, p0, ped, p2, posX, posY, posZ); } // 0x98C4FE6EC34154CA 0x9A0E3BFE
		...
		static void ANIMPOSTFX_PLAY(const char* effectName, int duration, BOOL looped) { invoke<Void>(0x2206BF9A37B7F724, effectName, duration, looped); } // 0x2206BF9A37B7F724 0x1D980479
		static void ANIMPOSTFX_STOP(const char* effectName) { invoke<Void>(0x068E835A1D0DC0E3, effectName); } // 0x068E835A1D0DC0E3 0x06BB5CDA
		static BOOL ANIMPOSTFX_IS_RUNNING(const char* effectName) { return invoke<BOOL>(0x36AD3E690DA5ACEB, effectName); } // 0x36AD3E690DA5ACEB 0x089D5921
		static void ANIMPOSTFX_STOP_ALL() { invoke<Void>(0xB4EDDC19532BFB85); } // 0xB4EDDC19532BFB85 0x4E6D875B
		static void _SWITCH_HUD(const char* graphicsName) { invoke<Void>(0xD2209BE128B5418C, graphicsName); } // 0xD2209BE128B5418C
	}
	...
	namespace STATS
	{
		...
		static BOOL STAT_SET_GXT_LABEL(Hash statName, const const char* value, BOOL save) { return invoke<BOOL>(0x17695002FD8B2AE0, statName, value, save); } // 0x17695002FD8B2AE0 0xC1224AA7
		...
		static BOOL STAT_SET_STRING(Hash statName, const const char* value, BOOL save) { return invoke<BOOL>(0xA87B2335D12531D7, statName, value, save); } // 0xA87B2335D12531D7 0xB1EF2E21
		...
		static BOOL STAT_SET_USER_ID(Hash playerName, const const char* value, BOOL save) { return invoke<BOOL>(0x8CDDF1E452BABE11, playerName, value, save); } // 0x8CDDF1E452BABE11 0xDBE78ED7
		...
		static const const char* STAT_GET_STRING(Hash statHash, int p1) { return invoke<char*>(0xE50384ACC2C3DB74, statHash, p1); } // 0xE50384ACC2C3DB74 0x10CE4BDE
		...
		static const const char* STAT_GET_USER_ID(Any* playerName) { return invoke<char*>(0x2365C388E393BBE2, playerName); } // 0x2365C388E393BBE2 0xE2E8B6BA
		static const const char* STAT_GET_LICENSE_PLATE(Hash statName) { return invoke<char*>(0x5473D4195058B2E4, statName); } // 0x5473D4195058B2E4 0x1544B29F
		static BOOL STAT_SET_LICENSE_PLATE(Hash statName, const const char* str) { return invoke<BOOL>(0x69FF13266D7296DA, statName, str); } // 0x69FF13266D7296DA 0x3507D253
		...
		static Hash _GET_NGSTAT_BOOL_HASH(int index, BOOL spStat, BOOL charStat, int character, const const char* section) { return invoke<Hash>(0xBA52FF538ED2BC71, index, spStat, charStat, character, section); } // 0xBA52FF538ED2BC71
		static Hash _GET_NGSTAT_INT_HASH(int index, BOOL spStat, BOOL charStat, int character, const const char* section) { return invoke<Hash>(0x2B4CDCA6F07FF3DA, index, spStat, charStat, character, section); } // 0x2B4CDCA6F07FF3DA
		...
		static void PLAYSTATS_RANDOM_MISSION_DONE(const char* name, Any p1, Any p2, Any p3) { invoke<Void>(0x71862B1D855F32E1, name, p1, p2, p3); } // 0x71862B1D855F32E1 0xAC2C7C63
		...
		static void PLAYSTATS_QUICKFIX_TOOL(int element, const const char* item) { invoke<Void>(0x90D0622866E80445, element, item); } // 0x90D0622866E80445 0x66FEB701
	...
	namespace APP
	{
		...
		static const const char* APP_GET_STRING(const char* property) { return invoke<char*>(0x749B023950D2311C, property); } // 0x749B023950D2311C 0x849CEB80
		...
		static void APP_SET_STRING(const char* property, const const char* value) { invoke<Void>(0x3FF2FCEC4B7721B4, property, value); } // 0x3FF2FCEC4B7721B4 0x23DF19A8
	...
	namespace CONTROLS
	{
		...
		static const const char* GET_CONTROL_INSTRUCTIONAL_BUTTON(int inputGroup, int control, BOOL p2) { return invoke<char*>(0x0499D7B09FC9B407, inputGroup, control, p2); } // 0x0499D7B09FC9B407 0x3551727A
		static const const char* _0x80C2FD58D720C801(int inputGroup, int control, BOOL p2) { return invoke<char*>(0x80C2FD58D720C801, inputGroup, control, p2); } // 0x80C2FD58D720C801 0x3EE71F6A
	...
	namespace DATAFILE
	{
		...
		static BOOL _0xC84527E235FCA219(const char* p0, BOOL p1, const const char* p2, Any* p3, Any* p4, const const char* type, BOOL p6) { return invoke<BOOL>(0xC84527E235FCA219, p0, p1, p2, p3, p4, type, p6); } // 0xC84527E235FCA219 0xF09157B0
		static BOOL _0xA5EFC3E847D60507(const char* p0, const const char* p1, const const char* p2, const const char* p3, BOOL p4) { return invoke<BOOL>(0xA5EFC3E847D60507, p0, p1, p2, p3, p4); } // 0xA5EFC3E847D60507 0xD96860FC
		static BOOL _0x648E7A5434AF7969(const char* p0, Any* p1, BOOL p2, Any* p3, Any* p4, Any* p5, const const char* type) { return invoke<BOOL>(0x648E7A5434AF7969, p0, p1, p2, p3, p4, p5, type); } // 0x648E7A5434AF7969 0x459F2683
		static BOOL _0x4645DE9980999E93(const char* p0, const const char* p1, const const char* p2, const const char* p3, const const char* type) { return invoke<BOOL>(0x4645DE9980999E93, p0, p1, p2, p3, type); } // 0x4645DE9980999E93 0xDBB83E2B
		static BOOL _0x692D808C34A82143(const char* p0, float p1, const const char* type) { return invoke<BOOL>(0x692D808C34A82143, p0, p1, type); } // 0x692D808C34A82143 0xBB6321BD
		...
		static const const char* DATAFILE_GET_FILE_DICT() { return invoke<char*>(0x906B778CA1DC72B6); } // 0x906B778CA1DC72B6 0x86DDF9C2
		...
		static void _OBJECT_VALUE_ADD_BOOLEAN(Any* objectData, const const char* key, BOOL value) { invoke<Void>(0x35124302A556A325, objectData, key, value); } // 0x35124302A556A325 0x9B29D99B
		static void _OBJECT_VALUE_ADD_INTEGER(Any* objectData, const const char* key, int value) { invoke<Void>(0xE7E035450A7948D5, objectData, key, value); } // 0xE7E035450A7948D5 0xEFCF554A
		static void _OBJECT_VALUE_ADD_FLOAT(Any* objectData, const const char* key, float value) { invoke<Void>(0xC27E1CC2D795105E, objectData, key, value); } // 0xC27E1CC2D795105E 0xE972CACF
		static void _OBJECT_VALUE_ADD_STRING(Any* objectData, const const char* key, const const char* value) { invoke<Void>(0x8FF3847DADD8E30C, objectData, key, value); } // 0x8FF3847DADD8E30C 0xD437615C
		static void _OBJECT_VALUE_ADD_VECTOR3(Any* objectData, const const char* key, float valueX, float valueY, float valueZ) { invoke<Void>(0x4CD49B76338C7DEE, objectData, key, valueX, valueY, valueZ); } // 0x4CD49B76338C7DEE 0x75FC6C3C
		static Any* _OBJECT_VALUE_ADD_OBJECT(Any* objectData, const const char* key) { return invoke<Any*>(0xA358F56F10732EE1, objectData, key); } // 0xA358F56F10732EE1 0x96A8E05F
		static Any* _OBJECT_VALUE_ADD_ARRAY(Any* objectData, const const char* key) { return invoke<Any*>(0x5B11728527CA6E5F, objectData, key); } // 0x5B11728527CA6E5F 0x03939B8D
		static BOOL _OBJECT_VALUE_GET_BOOLEAN(Any* objectData, const const char* key) { return invoke<BOOL>(0x1186940ED72FFEEC, objectData, key); } // 0x1186940ED72FFEEC 0x8876C872
		static int _OBJECT_VALUE_GET_INTEGER(Any* objectData, const const char* key) { return invoke<int>(0x78F06F6B1FB5A80C, objectData, key); } // 0x78F06F6B1FB5A80C 0xA6C68693
		static float _OBJECT_VALUE_GET_FLOAT(Any* objectData, const const char* key) { return invoke<float>(0x06610343E73B9727, objectData, key); } // 0x06610343E73B9727 0xA92C1AF4
		static const const char* _OBJECT_VALUE_GET_STRING(Any* objectData, const const char* key) { return invoke<char*>(0x3D2FD9E763B24472, objectData, key); } // 0x3D2FD9E763B24472 0x942160EC
		static Vector3 _OBJECT_VALUE_GET_VECTOR3(Any* objectData, const const char* key) { return invoke<Vector3>(0x46CD3CB66E0825CC, objectData, key); } // 0x46CD3CB66E0825CC 0xE84A127A
		static Any* _OBJECT_VALUE_GET_OBJECT(Any* sCloudFile, const const char* key) { return invoke<Any*>(0xB6B9DDC412FCEEE2, sCloudFile, key); } // 0xB6B9DDC412FCEEE2 0xC9C13D8D
		static Any* _OBJECT_VALUE_GET_ARRAY(Any* objectData, const const char* key) { return invoke<Any*>(0x7A983AA9DA2659ED, objectData, key); } // 0x7A983AA9DA2659ED 0x1F2F7D00
		static int _OBJECT_VALUE_GET_TYPE(Any* objectData, const const char* key) { return invoke<int>(0x031C55ED33227371, objectData, key); } // 0x031C55ED33227371 0x2678342A
		...
		static void _ARRAY_VALUE_ADD_STRING(Any* arrayData, const const char* value) { invoke<Void>(0x2F0661C155AEEEAA, arrayData, value); } // 0x2F0661C155AEEEAA 0xF3C01350
		...
		static const const char* _ARRAY_VALUE_GET_STRING(Any* arrayData, int arrayIndex) { return invoke<char*>(0xD3F2FFEB8D836F52, arrayData, arrayIndex); } // 0xD3F2FFEB8D836F52 0x93F985A6
	...
	namespace ZONE
	{
		...
		static const const char* GET_NAME_OF_ZONE(float x, float y, float z) { return invoke<char*>(0xCD90657D4C30E1CA, x, y, z); } // 0xCD90657D4C30E1CA 0x7875CE91
	...
	namespace ROPE
	{
		...
		static void LOAD_ROPE_DATA(Object rope, const const char* rope_preset) { invoke<Void>(0xCBB203C04D1ABD27, rope, rope_preset); } // 0xCBB203C04D1ABD27 0x9E8F1644
		...
		static void ATTACH_ENTITIES_TO_ROPE(Object rope, Entity ent1, Entity ent2, float ent1_x, float ent1_y, float ent1_z, float ent2_x, float ent2_y, float ent2_z, float length, BOOL p10, BOOL p11, const const char* boneName1, const const char* boneName2) { invoke<Void>(0x3D95EC8B6D940AC3, rope, ent1, ent2, ent1_x, ent1_y, ent1_z, ent2_x, ent2_y, ent2_z, length, p10, p11, boneName1, boneName2); } // 0x3D95EC8B6D940AC3 0x7508668F
	...
	namespace NETWORK
	{
		...
		static void _0xEBEFC2E77084F599(Any p0, const const char* p1, BOOL p2) { invoke<Void>(0xEBEFC2E77084F599, p0, p1, p2); } // 0xEBEFC2E77084F599 0xE0C28DB5
		static BOOL NETWORK_SEND_TRANSITION_GAMER_INSTRUCTION(int* networkHandle, const const char* p1, int p2, int p3, BOOL p4) { return invoke<BOOL>(0x31D1D2B858D25E6B, networkHandle, p1, p2, p3, p4); } // 0x31D1D2B858D25E6B 0x468B0884
		...
		static void NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(const char* vars, ScrHandle numVars) { invoke<Void>(0x3364AA97340CA215, vars, numVars); } // 0x3364AA97340CA215 0xBE3D32B4
		...
		static int NETWORK_GET_HOST_OF_SCRIPT(const char* scriptName, int instanceId, int positionHash) { return invoke<int>(0x1D6A14F1F9A736FC, scriptName, instanceId, positionHash); } // 0x1D6A14F1F9A736FC 0x9C95D0BB
		static void NETWORK_SET_MISSION_FINISHED() { invoke<Void>(0x3B3D11CD9FFCDFC9); } // 0x3B3D11CD9FFCDFC9 0x3083FAD7
		static BOOL NETWORK_IS_SCRIPT_ACTIVE(const char* scriptName, int instanceId, BOOL unk, int positionHash) { return invoke<BOOL>(0x9D40DF90FAD26098, scriptName, instanceId, unk, positionHash); } // 0x9D40DF90FAD26098 0x4A65250C
		...
		static const const char* NETWORK_GET_GAMERTAG_FROM_HANDLE(int* networkHandle) { return invoke<char*>(0x426141162EBE5CDB, networkHandle); } // 0x426141162EBE5CDB 0xA18A1B26
		...
		static const const char* NETWORK_MEMBER_ID_FROM_GAMER_HANDLE(int* networkHandle) { return invoke<char*>(0xC82630132081BB6F, networkHandle); } // 0xC82630132081BB6F 0x62EF0A63
		...
		static const const char* NETWORK_PLAYER_GET_NAME(Player player) { return invoke<char*>(0x7718D2E2060837D2, player); } // 0x7718D2E2060837D2 0xCE48F260
		static const const char* NETWORK_PLAYER_GET_USERID(Player player, const const char* userID) { return invoke<char*>(0x4927FC39CD0869A0, player, userID); } // 0x4927FC39CD0869A0 0x4EC0D983
		...
		static const const char* NETWORK_GET_FRIEND_NAME(int friendIndex) { return invoke<char*>(0xE11EBBB2A783FE8B, friendIndex); } // 0xE11EBBB2A783FE8B 0x97420B6D
		static const const char* _NETWORK_GET_FRIEND_NAME_FROM_INDEX(int friendIndex) { return invoke<char*>(0x4164F227D052E293, friendIndex); } // 0x4164F227D052E293
		...
		static BOOL NETWORK_ADD_FRIEND(int* networkHandle, const const char* message) { return invoke<BOOL>(0x8E02D73914064223, networkHandle, message); } // 0x8E02D73914064223 0x20E5B3EE
		...
		static void _NETWORK_SET_RICH_PRESENCE_2(int p0, const const char* gxtLabel) { invoke<Void>(0x3E200C2BCF4164EB, p0, gxtLabel); } // 0x3E200C2BCF4164EB 0x017E6777
		...
		static BOOL _NETWORK_CLAN_ANIMATION(const char* animDict, const const char* animName) { return invoke<BOOL>(0x729E3401F0430686, animDict, animName); } // 0x729E3401F0430686 0xBDA90BAC
		static BOOL _0x2B51EDBEFC301339(int p0, const const char* p1) { return invoke<BOOL>(0x2B51EDBEFC301339, p0, p1); } // 0x2B51EDBEFC301339 0x8E952B12
		...
		static const const char* GET_TIME_AS_STRING(int time) { return invoke<char*>(0x9E23B1777A927DAD, time); } // 0x9E23B1777A927DAD 0x8218944E
		...
		static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(Ped ped, int netScene, const const char* animDict, const const char* animName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, Any p9) { invoke<Void>(0x742A637471BCECD9, ped, netScene, animDict, animName, speed, speedMultiplier, duration, flag, playbackRate, p9); } // 0x742A637471BCECD9 0xB386713E
		static void NETWORK_ADD_ENTITY_TO_SYNCHRONISED_SCENE(Entity entity, int netScene, const const char* animDict, const const char* animName, float speed, float speedMulitiplier, int flag) { invoke<Void>(0xF2404D68CBC855FA, entity, netScene, animDict, animName, speed, speedMulitiplier, flag); } // 0xF2404D68CBC855FA 0x10DD636C
		static void _NETWORK_FORCE_LOCAL_USE_OF_SYNCED_SCENE_CAMERA(int netScene, const const char* animDict, const const char* animName) { invoke<Void>(0xCF8BD3B0BD6D42D7, netScene, animDict, animName); } // 0xCF8BD3B0BD6D42D7 0xBFFE8B5C
		...
		static BOOL NETWORK_DOES_TUNABLE_EXIST(const char* tunableContext, const const char* tunableName) { return invoke<BOOL>(0x85E5F8B9B898B20A, tunableContext, tunableName); } // 0x85E5F8B9B898B20A 0x9FCE9C9A
		static BOOL NETWORK_ACCESS_TUNABLE_INT(const char* tunableContext, const const char* tunableName, int* value) { return invoke<BOOL>(0x8BE1146DFD5D4468, tunableContext, tunableName, value); } // 0x8BE1146DFD5D4468 0xE4B3726A
		static BOOL NETWORK_ACCESS_TUNABLE_FLOAT(const char* tunableContext, const const char* tunableName, float* value) { return invoke<BOOL>(0xE5608CA7BC163A5F, tunableContext, tunableName, value); } // 0xE5608CA7BC163A5F 0x41E8912A
		static BOOL NETWORK_ACCESS_TUNABLE_BOOL(const char* tunableContext, const const char* tunableName) { return invoke<BOOL>(0xAA6A47A573ABB75A, tunableContext, tunableName); } // 0xAA6A47A573ABB75A 0x8A04E1FE
		...
		static void _0x58C21165F6545892(const char* p0, const const char* p1) { invoke<Void>(0x58C21165F6545892, p0, p1); } // 0x58C21165F6545892 0x365C50EE
		...
		static BOOL _0x158EC424F35EC469(const char* p0, BOOL p1, const const char* contentType) { return invoke<BOOL>(0x158EC424F35EC469, p0, p1, contentType); } // 0x158EC424F35EC469 0xDED82A6E
		...
		static BOOL _0x6D4CB481FAC835E8(Any p0, Any p1, const const char* p2, Any p3) { return invoke<BOOL>(0x6D4CB481FAC835E8, p0, p1, p2, p3); } // 0x6D4CB481FAC835E8 0x40CF0783
		...
		static const const char* GET_PLAYER_ADVANCED_MODIFIER_PRIVILEGES(int p0) { return invoke<char*>(0xCD67AD041A394C9C, p0); } // 0xCD67AD041A394C9C 0x8F3137E6
		...
		static const const char* _GET_CONTENT_ID(Any p0) { return invoke<char*>(0x55AA95F481D694D2, p0); } // 0x55AA95F481D694D2 0x331AEABF
		static const const char* _GET_ROOT_CONTENT_ID(Any p0) { return invoke<char*>(0xC0173D6BFF4E0348, p0); } // 0xC0173D6BFF4E0348 0x0E5E8E5C
		...
		static BOOL _FACEBOOK_SET_HEIST_COMPLETE(const char* heistName, int cashEarned, int xpEarned) { return invoke<BOOL>(0x098AB65B9ED9A9EC, heistName, cashEarned, xpEarned); } // 0x098AB65B9ED9A9EC 0x30B51753
		...
		static int TEXTURE_DOWNLOAD_REQUEST(int* PlayerHandle, const const char* FilePath, const const char* Name, BOOL p3) { return invoke<int>(0x16160DA74A8E74A2, PlayerHandle, FilePath, Name, p3); } // 0x16160DA74A8E74A2 0xAD546CC3
		...
		static const const char* TEXTURE_DOWNLOAD_GET_NAME(int p0) { return invoke<char*>(0x3448505B6E35262D, p0); } // 0x3448505B6E35262D 0xA40EF65A
	...
	namespace NETWORKCASH
	{
		...
		static void NETWORK_REFUND_CASH(int m_Index, const const char* szType, const const char* szReason, BOOL bUnk) { invoke<Void>(0xF9C812CD7C46E817, m_Index, szType, szReason, bUnk); } // 0xF9C812CD7C46E817 0x07C92F21
		...
		static void NETWORK_EARN_FROM_BETTING(int amount, const const char* p1) { invoke<Void>(0x827A5BA1A44ACA6D, amount, p1); } // 0x827A5BA1A44ACA6D 0xA0F7F07C
		static void NETWORK_EARN_FROM_JOB(int amount, const const char* p1) { invoke<Void>(0xB2CC4836834E8A98, amount, p1); } // 0xB2CC4836834E8A98 0x0B6997FC
		static void _NETWORK_EARN_FROM_BEND_JOB(int amount, const const char* heistHash) { invoke<Void>(0x61326EE6DF15B0CA, amount, heistHash); } // 0x61326EE6DF15B0CA 0x5E81F55C
		...
		static void _NETWORK_EARN_FROM_DAILY_OBJECTIVE(int p0, const const char* p1, int p2) { invoke<Void>(0x6EA318C91C1A8786, p0, p1, p2); } // 0x6EA318C91C1A8786
		static void _NETWORK_EARN_FROM_AMBIENT_JOB(int p0, const const char* p1, Any* p2) { invoke<Void>(0xFB6DB092FBAE29E6, p0, p1, p2); } // 0xFB6DB092FBAE29E6
		...
		static void NETWORK_BUY_ITEM(Ped player, Hash item, Any p2, Any p3, BOOL p4, const const char* item_name, Any p6, Any p7, Any p8, BOOL p9) { invoke<Void>(0xF0077C797F66A355, player, item, p2, p3, p4, item_name, p6, p7, p8, p9); } // 0xF0077C797F66A355 0xA07B6368
		...
		static const const char* PROCESS_CASH_GIFT(int* p0, int* p1, const const char* p2) { return invoke<char*>(0x20194D48EAEC9A41, p0, p1, p2); } // 0x20194D48EAEC9A41 0xC5D8B1E9
		...
		static const const char* _NETWORK_GET_BANK_BALANCE_STRING() { return invoke<char*>(0xA6FA3979BED01B81); } // 0xA6FA3979BED01B81
	...
	namespace DECORATOR
	{
		static BOOL DECOR_SET_TIME(Entity entity, const const char* propertyName, int timestamp) { return invoke<BOOL>(0x95AED7B8E39ECAA4, entity, propertyName, timestamp); } // 0x95AED7B8E39ECAA4 0xBBAEEF94
		static BOOL DECOR_SET_BOOL(Entity entity, const const char* propertyName, BOOL value) { return invoke<BOOL>(0x6B1E8E2ED1335B71, entity, propertyName, value); } // 0x6B1E8E2ED1335B71 0x8E101F5C
		static BOOL _DECOR_SET_FLOAT(Entity entity, const const char* propertyName, float value) { return invoke<BOOL>(0x211AB1DD8D0F363A, entity, propertyName, value); } // 0x211AB1DD8D0F363A
		static BOOL DECOR_SET_INT(Entity entity, const const char* propertyName, int value) { return invoke<BOOL>(0x0CE3AA5E1CA19E10, entity, propertyName, value); } // 0x0CE3AA5E1CA19E10 0xDB718B21
		static BOOL DECOR_GET_BOOL(Entity entity, const const char* propertyName) { return invoke<BOOL>(0xDACE671663F2F5DB, entity, propertyName); } // 0xDACE671663F2F5DB 0xDBCE51E0
		static float _DECOR_GET_FLOAT(Entity entity, const const char* propertyName) { return invoke<float>(0x6524A2F114706F43, entity, propertyName); } // 0x6524A2F114706F43
		static int DECOR_GET_INT(Entity entity, const const char* propertyName) { return invoke<int>(0xA06C969B02A97298, entity, propertyName); } // 0xA06C969B02A97298 0xDDDE59B5
		static BOOL DECOR_EXIST_ON(Entity entity, const const char* propertyName) { return invoke<BOOL>(0x05661B80A8C9165F, entity, propertyName); } // 0x05661B80A8C9165F 0x74EF9C40
		static BOOL DECOR_REMOVE(Entity entity, const const char* propertyName) { return invoke<BOOL>(0x00EE9F297C738720, entity, propertyName); } // 0x00EE9F297C738720 0xE0E2640B
	...
	namespace SOCIALCLUB
	{
		...
		static BOOL SC_INBOX_MESSAGE_GET_DATA_INT(int p0, const const char* context, int* out) { return invoke<BOOL>(0xA00EFE4082C4056E, p0, context, out); } // 0xA00EFE4082C4056E 0x88068C7C
		static BOOL _SC_INBOX_MESSAGE_GET_DATA_BOOL(int p0, const const char* p1) { return invoke<BOOL>(0xFFE5C16F402D851D, p0, p1); } // 0xFFE5C16F402D851D
		static BOOL SC_INBOX_MESSAGE_GET_DATA_STRING(int p0, const const char* context, const const char* out) { return invoke<BOOL>(0x7572EF42FC6A9B6D, p0, context, out); } // 0x7572EF42FC6A9B6D 0x15607620
		static BOOL _SC_INBOX_MESSAGE_PUSH(int p0) { return invoke<BOOL>(0x9A2C8064B6C1E41A, p0); } // 0x9A2C8064B6C1E41A 0xEBE420A4
		static const const char* _SC_INBOX_MESSAGE_GET_STRING(int p0) { return invoke<char*>(0xF3E31D16CBDCB304, p0); } // 0xF3E31D16CBDCB304 0x2C959AF9
		...
		static void _CREATE_PRESENCE_STAT_UPDATE(const char* p0) { invoke<Void>(0xA68D3D229F4F3B06, p0); } // 0xA68D3D229F4F3B06 0x75324674
		...
		static BOOL _CREATE_PRESENCE_BOUNTY(const char* playerName) { return invoke<BOOL>(0x6AFD2CD753FEEF83, playerName); } // 0x6AFD2CD753FEEF83 0x628F489B
		...
		static const const char* _0xDF649C4E9AFDD788() { return invoke<char*>(0xDF649C4E9AFDD788); } // 0xDF649C4E9AFDD788 0x468668F0
		...
		static BOOL _0x8CC469AB4D349B7C(int p0, const const char* p1, Any* p2) { return invoke<BOOL>(0x8CC469AB4D349B7C, p0, p1, p2); } // 0x8CC469AB4D349B7C 0xE778B2A7
		static BOOL _0x699E4A5C8C893A18(int p0, const const char* p1, Any* p2) { return invoke<BOOL>(0x699E4A5C8C893A18, p0, p1, p2); } // 0x699E4A5C8C893A18 0xCE7D50A8
		...
		static const const char* _SC_GET_NICKNAME() { return invoke<char*>(0x198D161F458ECC7F); } // 0x198D161F458ECC7F
	...
	namespace UNK2
	{
		static void _TOGGLE_PHONE_FILTER(const char* p0, BOOL p1) { invoke<Void>(0x7E2BD3EF6C205F09, p0, p1); } // 0x7E2BD3EF6C205F09
	...
	namespace UNK3
	{
		...
		static const const char* _GET_ONLINE_VERSION() { return invoke<char*>(0xFCA9373EF340AC0A); } // 0xFCA9373EF340AC0A
	}
}